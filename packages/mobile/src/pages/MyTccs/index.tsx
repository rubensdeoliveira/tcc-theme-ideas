  ...
  useFocusEffect(
    useCallback(() => {
      async function getTccs() {
        const uri = `tccs/created/me?page=${page}`
  ...
  return (
    <>
      <Header>
        ...
        <HeaderTitle>Meus Temas Cadastrados</HeaderTitle>
      </Header>
      <Container>
        {tccs.length > 0 ? (
          <>
          ...
          >
            <Text style={{ fontSize: 22 }}>Não há temas cadastrados</Text>
          </View>
        )}
      </Container>
    </>
